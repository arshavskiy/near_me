      ...
      return (() => {
        ...
        return (() => {
          ...
          function p(e3, t3, n2, o2, i2, s2, r2, a2) {
            ...
            if (t3 && (c2.render = t3, c2.staticRenderFns = n2, c2._compiled = true), o2 && (c2.functional = true), s2 && (c2._scopeId = "data-v-" + s2), r2 ? (l2 = function(e4) {
              (e4 = e4 || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext) || "undefined" == typeof __VUE_SSR_CONTEXT__ || (e4 = __VUE_SSR_CONTEXT__), i2 && i2.call(this, e4), e4 && e4._registeredComponents && e4._registeredComponents.add(r2);
            }, c2._ssrRegister = l2) : i2 && (l2 = a2 ? function() {
              i2.call(this, (c2.functional ? this.parent : this).$root.$options.shadowRoot);
            } : i2), l2) if (c2.functional) {
              c2._injectStyles = l2;
              var u2 = c2.render;
              c2.render = function(e4, t4) {
                return l2.call(t4), u2(e4, t4);
              };
            } else {
          ...
          }, [], false, null, null, null).exports }, d = { inserted: function(e3, t3, n2) {
            var o2 = n2.context;
            if (o2.appendToBody) {
...
export default require_vue_select();
